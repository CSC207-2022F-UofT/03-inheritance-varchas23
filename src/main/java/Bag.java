...
public abstract class Bag {
    ...
    public boolean addItem(String i){
        if (this.numberOfContents < this.capacity){
            ...
            String[] addContent = new String[this.numberOfContents];
            for (int i = 0; i < this.contents.length; i++){
                addContent[i] = this.contents[i];
            }
            addContent[this.numberOfContents - 1] = i;
            this.contents = addContent;
            return true;
        }
        return false;
    }
